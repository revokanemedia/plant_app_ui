...
import { Button, FlatList, Image, ScrollView, StatusBar, StyleSheet, Text, TextInput, View } from 'react-native';
...
import { AppNavigatorProps, HomeNavigatorProps } from '../navigation/types';
